...
<body>
    ...
    <div class="main-content">
        ...
        <p class="menu-page-description">Jelajahi berbagai pilihan makanan dan minuman lezat yang kami tawarkan. Setiap
            hidangan dibuat dengan bahan-bahan segar pilihan untuk memastikan cita rasa terbaik.</p>
                    ...
                    <div class="menu-grid">
                        <?php foreach ($items_in_category as $menu_item): ?>
                            <div class="menu-item-card">
                                ...
                                <?php
                                $image_path = "../images/" . htmlspecialchars($menu_item['image']);
                                echo "<img src='$image_path' alt='Gambar " . htmlspecialchars($menu_item['nama']) . "'>";
                                ?>
